...
This package is currently experimental and pins Monty v0.0.19 exactly.
...
```bash
go get github.com/ewhauser/gomonty@vX.Y.Z
go install github.com/ewhauser/gomonty/cmd/gomonty@vX.Y.Z
